  ...
  return (
    <div class="flex flex-col gap-5 ">
      <div class="space-y-3">
        ...
        <button
          class="flex items-center gap-1 rounded-lg bg-black p-2 pl-4 pr-5 text-white disabled:cursor-not-allowed disabled:text-white/70"
        ...
        >
          ...
          {isDeploying.value ? "Deploying..." : "Deploy"}
        </button>
      </div>
      <hr />
